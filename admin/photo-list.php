                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($rs)) {
                                            ...
                                            echo '<td>' . $row['type'] . '</td>';
                                            echo '<td>' . $row['name'] . '</td>';
                                            echo '<td><a href="' . $row['thumbnail'] . '" target="_blank">View File</a></td>';
                                            ...
                                            echo '<td><a href="photo.php?action=' . base64_encode("Edit") . '&id=' . base64_encode($row['id']) . '" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
