                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body overflow-scroll" id="records">
                                <h5 class="card-title">Home List</h5>
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($rs)) {
                                            ...
                                            echo '<td><a href="home.php?action=' . base64_encode("Edit") . '&id=' . base64_encode($row['id']) . '" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
