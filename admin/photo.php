...
<head>
    ...
    <script src="scripts/photo.js" type="text/javascript" language="javascript"></script>
</head>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <form id="photo" action="photo-action.php" class="row g-3 needs-validation" novalidate="">


                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label"><b>Gallery Type</b></label>
                                        <input value="<?php if (isset($_GET['id'])) echo $row['type'] ?>" type="text" class="form-control" id="type" name="type" required="">
                                        <div class="invalid-feedback">
                                            Please enter Gallery Type.
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label"><b>Gallery Name</b></label>
                                        <input value="<?php if (isset($_GET['id'])) echo $row['name'] ?>" type="text" class="form-control" id="name" name="name" required="">
                                        <div class="invalid-feedback">
                                            Please enter Gallery Name.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group py-2">
                                            ...
                                            <input class="form-control" value="<?php if (isset($_GET['id'])) echo $row['thumbnail'] ?>" type="file" id="thumbnail" name="thumbnail" multiple />
                                    ...
                                    <div class="col-12">
                                        ...
                                        ?>
                                            ...
                                            <a href="photo-list.php"><button class="btn btn-lg btn-danger" type="button">Cancel</button></a>
                                        <?php
                                        } else {
                                        ?>
