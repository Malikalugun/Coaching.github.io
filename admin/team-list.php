                            ...
                            <div class="card-body overflow-scroll" id="records">
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        $sl = 1;
                                        $sql = "select * from tbl_teams where deleted_at is NULL order by id desc";
                                        ...
                                        while ($row = mysqli_fetch_assoc($rs)) {
                                            ...
                                            echo '<td>' . $row['name'] . '</td>';
                                            echo '<td>' . $row['bio'] . '</td>';
                                            echo '<td><a href="' . $row['team_photo'] . '" target="_blank">View File</a></td>';
                                            ...
                                            echo '<td><a href="team.php?action=' . base64_encode("Edit") . '&id=' . base64_encode($row['id']) . '" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
