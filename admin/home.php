...
<head>
    ...
    <script src="scripts/home.js" type="text/javascript" language="javascript"></script>
</head>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <form id="home" action="home-action.php" class="row g-3 needs-validation" novalidate="">


                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label"><b>Home Title</b></label>
                                        <input value="<?php if (isset($_GET['id'])) echo $row['title'] ?>" type="text" class="form-control" id="title" name="title" required="">
                                        <div class="invalid-feedback">
                                            Please enter home Title.
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label"><b>Order Item</b></label>
                                        <input value="<?php if (isset($_GET['id'])) echo $row['order_item'] ?>" type="text" class="form-control" id="order_item" name="order_item" required="">
                                        <div class="invalid-feedback">
                                            Please enter home Title.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        ?>
                                            ...
                                            <a href="home-list.php"><button class="btn btn-lg btn-danger" type="button">Cancel</button></a>
                                        <?php
                                        } else {
                                        ?>
