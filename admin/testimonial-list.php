                            ...
                            <div class="card-body overflow-scroll" id="records">
                                ...
                                <table class="table datatable">
                                    <thead>
                                        <tr>
                                            <th scope="col">Sl</th>
                                            <th scope="col">Testimonial Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        $sl = 1;
                                        $sql = "select * from tbl_testimonial where deleted_at is NULL order by id desc";
                                        ...
                                        while ($row = mysqli_fetch_assoc($rs)) {
                                            ...
                                            echo '<td><a href="testimonial.php?action=' . base64_encode("Edit") . '&id=' . base64_encode($row['id']) . '" class="btn btn-primary"><i class="bi bi-pencil"></i></a>
