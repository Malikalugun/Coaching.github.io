                ...
                <div class="col-lg-4 col-md-8">
                    <div class="teachers-left mt-50">
                        ...
                        <div class="description">
                            <p>A teacher doesn't only teach. They also inspire and encourage their students to be their best version of themselves. And this can have a tremendous impact on how students interact with others now, and in the future.</p>
                        </div>
                    </div> <!-- teachers left -->
                </div>
                <div class="col-lg-8">
                            ...
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    <div class="singel-dashboard pt-40">
                                        <h5>About</h5>
                                        <p>Teachers do not become teachers because they are not smart enough to do anything else. Instead, they become teachers because they want to make a difference in shaping young peoples' lives.</p>
                                    </div> <!-- singel dashboard -->
                                    <div class="singel-dashboard pt-40">
                                        <h5>Acchivments</h5>
                                        <p>Achievement goals refer to the aim, purpose, or focus of a person’s achievement behavior. These goals are dynamic cognitive entities representing future-based possibilities that respond to changes in the person as well as the situation.</p>
                                    </div> <!-- singel dashboard -->
                                    <div class="singel-dashboard pt-40">
                                        <h5>My Objective</h5>
                                        <p>Every coaching, even if it is just one session, needs an objective. Otherwise, it’s just a chat. In this article, I will tell you what an objective might be, giving you examples of coaching objective</p>
                                    </div> <!-- singel dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
